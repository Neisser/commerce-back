...
const EmailTemplates = require('../../network/templates')
...
const addProduct = async (req, res, next) => {
    try {
        ...
        //Sendgrid Example Implementation
        const mail = {
            to: 'villa.neisser@gmail.com',
            subject: 'Hello, You have created a new product',
            template: EmailTemplates.OrderGenerated('Neyvill', 'clusthers.com')
        }
