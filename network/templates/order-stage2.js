...
const OrderStage2 = (
    ...
    html { -webkit-text-size-adjust: none; -ms-text-size-adjust: none;}
        ...
        @media only screen and (max-device-width: 750px), only screen and (max-width: 750px){
          ...
          .mob_title1 {font-size: 30px !important; line-height: 35px !important;}
          .mob_title2 {font-size: 22px !important; line-height: 28px !important;}
                         ...
                         <tr>
                            <td align="center" valign="top">
                               <font class="mob_title1" face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 30px; line-height: 45px; font-weight: 300; letter-spacing: -1px;">
                                  <span class="mob_title1" style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color:#000; font-size: 30px; line-height: 45px; font-weight: 300; letter-spacing: -1px;">Hello  ${username} <br/> <br/>Please verify your Inferno Hub account by clicking the link below:</span>
                               </font>
                                     ...
                                     <td align="center" valign="top"> 
                                        <a href="${url}" target="_blank" style="display: block; border-radius: 4px; padding: 10px 55px; font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                                           <font face="'Source Sans Pro', sans-serif" color="#ffffff" style="font-size: 26px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                                              <span style="font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 16px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">Verify&nbsp;Email</span>
                                           </font>
                                        </a>
                                     </td>
                                  </tr>
                         ...
                         <tr>
                            <td class="mob_left" align="center" valign="top">
                               ...
                               <font face="'Source Sans Pro', sans-serif" color="#8c8c8c" style="font-size: 17px; line-height: 23px;">
                                  <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #8c8c8c; font-size: 17px; line-height: 23px;">If you have any issues with the verification process, don't hesitate to reach us using the links below.</span>
                               </font>
                                  ...
                                  <tr>
                                     <td align="center" valign="top">
                                        ...
                                        <font face="'Source Sans Pro', sans-serif" color="#868686" style="font-size: 13px; line-height: 16px;">
                                           <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #868686; font-size: 13px; line-height: 16px;">Copyright &copy; 2020 Inferno Hub. All&nbsp;Rights&nbsp;Reserved. </span>
                                        </font>
                                        <div style="height: 3px; line-height: 3px; font-size: 1px;">&nbsp;</div>
                                        <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 13px; line-height: 16px;">
                                           <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 13px; line-height: 16px;"><a href="#" target="_blank" style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #ee4037; font-size: 15px; line-height: 18px; text-decoration: none;">help@infernohub.com</a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="#" target="_blank" style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #ee4037; font-size: 15px; line-height: 18px; text-decoration: none;">infernohub.com</a></span>
                                        </font>
