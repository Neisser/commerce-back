...
const OrderGenerated = (
   ...
   details.map(current => {
      valueImage += `<td align="center" style="padding:0;Margin:0;font-size:0"><a style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#3CA7F1;font-size:14px"><img class="adapt-img" src="${current.imageProduct[0]}" alt width="103" height="159" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></a></td> `
      value += `<p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#333333;font-size:14px"><span style="font-size:16px"><strong style="line-height:150%">${current.product}</strong></span></p>`
      current.detailsProduct.map(accumulator => {
         for (const key in accumulator) {
            if (key != '_id')
               value += `<p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#333333;font-size:14px"><strong>${key}</strong>: ${accumulator[key]}</p>`
         }
         return value += `<br><br>`
      })
                    ...
                    <tr style="border-collapse:collapse"> 
                     <td valign="top" align="center" style="padding:0;Margin:0;width:580px"> 
                      <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                        <tr style="border-collapse:collapse"> 
                         <td align="center" style="padding:0;Margin:0"><h2 style="Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:Arial, sans-serif;font-size:24px;font-style:normal;font-weight:normal;color:#191919">clothes ordered<br></h2></td> 
                        </tr> 
                      </table></td> 
                    </tr> 
                  </table></td> 
                         ...
                         <td align="center" style="padding:0;Margin:0;padding-bottom:15px"> 
                          <table class="cke_show_border" height="101" cellspacing="1" cellpadding="1" border="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:240px">                        
                            ...
                            <tr style="border-collapse:collapse"> 
                             ...
                             <td style="padding:0;Margin:0;text-align:right"><span style="font-size:18px;line-height:36px"><strong>$${invoice.total}</strong></span></td> 
                            </tr> 
                          </table></td> 
                        </tr> 
                      </table></td> 
                    ...
                    <tr style="border-collapse:collapse"> 
                     <td class="es-m-p20b" align="left" style="padding:0;Margin:0;width:270px"> 
                      <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                        ...
                        <tr style="border-collapse:collapse"> 
                         <td align="left" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#333333;font-size:14px"><strong>Order №:</strong> ${data._id}</p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#333333;font-size:14px"><strong>Member №:</strong> ${invoice.userId}</p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#333333;font-size:14px"><strong>Shipping Method:</strong> Standard</p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#333333;font-size:14px"><strong>Order date:</strong> ${new Date(invoice.created_at)}</p></td> 
                        </tr> 
                      </table></td> 
                    </tr> 
                  </table> 
                    ...
                    <tr style="border-collapse:collapse"> 
                     <td align="left" style="padding:0;Margin:0;width:270px"> 
                      <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                        ...
                        <tr style="border-collapse:collapse"> 
                         <td align="left" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#333333;font-size:14px">${data.address.country} -- ${data.address.province} -- ${data.address.city}<strong></strong></p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#333333;font-size:14px">${data.address.location} -- ${data.address.postal_code}</p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#333333;font-size:14px">Conacto: ${data.address.neighborhood} -- ${data.address.optional}<br></p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#333333;font-size:14px">Estimated delivery: 04/10/16 - 04/14/16<br></p></td> 
                        </tr> 
                      </table></td> 
                    </tr> 
                  </table> 
